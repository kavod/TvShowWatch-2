...
msg = ''
try:
	with open(os.path.dirname(os.path.abspath(__file__)) + '/login.json') as data_file:    
		login = json.load(data_file)
except:
	msg="login.json file in \"" + os.path.dirname(os.path.abspath(__file__)) + '" directory is expected with following content:\n{"username":"your_username","password":"your_password"}'
